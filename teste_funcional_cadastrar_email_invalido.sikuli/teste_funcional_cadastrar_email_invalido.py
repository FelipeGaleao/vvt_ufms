...
def verificar_aviso_email():
    popup_msg_cadastrado = "popup_msg_cadastrado.png"
    if(exists(popup_msg_cadastrado)):
        print("O usuário não conseguiu se cadastrar")
    else: 
        print("O usuário foi cadastrado!")
        
abrir_sistema()
cadastrar_atleta("Maycon", "Mota", "0020", "07209087151", "00010", "07/06/2001", "79062370", "Brasileiro", "64999522359", "64999522359", "Palmeiras", "Instagram", "teste32mail.com", "sen", "sen")
verificar_aviso_email()