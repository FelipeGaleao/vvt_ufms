...
def cadastrar_atleta(nome, sobrenome, cartao_sus, cpf, rg, dt_nascimento, cep, nacionalidade, celular, telefone, clube, face, email, senha, confirmar):
...
def verificar_msg_popup():
    popup_msg_cadastrado = "popup_msg_cadastrado.png"
    if(exists(popup_msg_cadastrado)):
        print("A mensagem do usuário cadastrado foi exibida!")
    else: 
        print("A mensagem do usuário cadastrado não foi exibida")
abrir_sistema()
cadastrar_atleta("Maycon", "Mota", "0020", "07209087109", "00010", "07/06/2001", "79062370", "Brasileiro", "64999522359", "64999522359", "Palmeiras", "Instagram", "teste2@gmail.com", "senha123", "senha123")
verificar_msg_popup()