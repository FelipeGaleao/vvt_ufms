...
def verificar_msg_popup():
    ...
    if(exists(popup_msg_cadastrado)):
        print("O usuário foi cadastrado foi cadastrado!")
    else: 
        print("O usuário foi cadastrado não foi cadastrado!")
abrir_sistema()
cadastrar_atleta("Maycon", "Mota", "0020", "07209087154", "00010", "07/06/2001", "79062370", "Brasileiro", "64999522359", "64999522359", "Palmeiras", "Instagram", "teste32@gmail.com", "sen", "sen")
verificar_msg_popup()