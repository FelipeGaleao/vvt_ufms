...
def imprimir_resultados():
    btn_visualizar = "btn_visualizar.png"
    tela_imprimir = "tela_imprimir.png"
    btn_imprimir = "btn_imprimir.png"
    tela_impressao = "tela_impressao.png"

    click(btn_visualizar)
    time.sleep(5)
    wait(tela_imprimir)
    if exists (tela_imprimir):
        type(Key.PAGE_DOWN*25)
        click(btn_imprimir)
        time.sleep(5)
        wait(tela_impressao)
